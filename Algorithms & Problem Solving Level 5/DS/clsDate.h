...
public:
	...
	clsDate(short _Day, short Month, short Year)
	{
	...
	static string GetSystemDateTimeString()
	{
		...
		short _Day, _Month, _Year,Hour,Minute,Second;
		...
		return (to_string(_Day) + "/" + to_string(_Month) + "/"
			+ to_string(_Year) + " - "
	...
	static clsDate GetDateFromDayOrderInYear(short DateOrderInYear, short _Year)
	{
